...
def edit():
    ...
    f_name=Entry(top_editor,width=30,bg="#2c3e50",fg="#ecf0f1",)
    f_name.grid(row=0,column=1,padx=20,pady=(10,0),ipady=5)
    l_name=Entry(top_editor,width=30,bg="#2c3e50",fg="#ecf0f1",)
    l_name.grid(row=1,column=1,ipady=5)
    address=Entry(top_editor,width=30,bg="#2c3e50",fg="#ecf0f1",)
    address.grid(row=2,column=1,ipady=5)

    f_name_label=Label(top_editor,text="First name :",bg="#2c3e50",fg="#ecf0f1",font=("Segoe UI",9,"bold"))
    f_name_label.grid(row=0,column=0,pady=(10,0))

    l_name_label=Label(top_editor,text="Last name :",bg="#2c3e50",fg="#ecf0f1",font=("Segoe UI",9,"bold"))
    l_name_label.grid(row=1,column=0,pady=5)

    address_label=Label(top_editor,text="Address :",bg="#2c3e50",fg="#ecf0f1",font=("Segoe UI",9,"bold"))
    address_label.grid(row=2,column=0,pady=5)
    
    edit_btn=Button(top_editor,text="save" ,bg="#7538c0", fg="#ecf0f1",height=2 )
...
delete_label=Label(root,text="Delete ID :",bg="#2c3e50",fg="#ecf0f1",font=("Segoe UI",9,"bold"))
...
edit_btn=Button(root,text="Edit" ,bg="#7538c0", fg="#ecf0f1",height=2 ,command=edit)
